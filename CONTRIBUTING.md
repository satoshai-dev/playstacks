...
1. **Select the package** — pick `playstacks`
...
| `pre-push` | Before every push | `pnpm test` (29 unit tests) |
...
| `pnpm test:e2e` | Run E2E tests (`examples/zest-e2e/`) |
...
```
playstacks/
├── packages/playstacks/     # The published npm package
│   ├── src/                 # Library source code
│   ├── tests/unit/          # Vitest unit tests
│   ├── CHANGELOG.md         # Auto-generated by changesets
│   └── package.json         # version: "0.1.1"
├── examples/zest-e2e/       # E2E reference tests (Zest Protocol)
